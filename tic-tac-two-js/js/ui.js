export function menuScreen(startGame) {
...
export function getBoard(boardState, updateFunction, isInGrid) {
...
export function getGridButtons(handleMoveGrid, currentPlayerMoves, checkForWin) {
